package com.fanke.backlibrary.mapper;
...
public interface SalesMapper {
     ...
     * @return
     */
    List<sales> selectSalesByFenye(@Param("pageNo") Integer pageNo, @Param("pageSize") Integer pageSize,@Param("titleId") Integer titleId);
