...
public class sales {
    ...
    public com.fanke.backlibrary.pojo.usersn getUsersn() {
        return usersn;
    }

    public void setUsersn(com.fanke.backlibrary.pojo.usersn usersn) {
        this.usersn = usersn;
    }

    public com.fanke.backlibrary.pojo.doubanbookInfo getDoubanbookInfo() {
        return doubanbookInfo;
    }

    public void setDoubanbookInfo(com.fanke.backlibrary.pojo.doubanbookInfo doubanbookInfo) {
