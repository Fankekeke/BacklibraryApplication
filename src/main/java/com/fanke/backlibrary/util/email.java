...
public class email {
    ...
    private static String myEmailAccount = "1258846421@qq.com";
    private static String myEmailPsw = "ocsjqovclndhhbbf";//yonyivmzpseddeae
    //QQSMTP服务器地址为:smtp.qq.com
    private static String myEmailSMTPHost = "smtp.qq.com";

    public static void sendEmail(String uname,String title,String receiveMailAccount) throws Exception {
        ...
        //3.创建一封邮件
        MimeMessage message = createMimeMessage(session, myEmailAccount, receiveMailAccount,uname,title);
     ...
     * @throws Exception
     */
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String uname,String title) throws Exception {
        ...
        message.setContent("尊敬的"+uname+":<br/>   您所借阅的图书《"+title+"》即将到归还期,请尽快送往图书馆", "text/html;charset=utf-8");
